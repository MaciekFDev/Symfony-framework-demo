...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Q3Xe3fF'] ?? $container->load('get_ServiceLocator_Q3Xe3fFService'))->withContext('App\\Controller\\SecurityController', $container));
